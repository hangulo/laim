...
export function ThreadReader({ threadId, accountId }: { threadId: string; accountId: string }) {
  ...
  return (
    <div className="flex gap-6 items-start">
      ...
      {/* Sidebar */}
      <aside className="w-64 shrink-0 rounded-xl border border-neutral-200 bg-white p-4 shadow-sm max-h-[calc(100vh-80px)] overflow-y-auto sticky top-4 dark:border-neutral-700 dark:bg-neutral-900">
